...
// MaxReviewersPerPR Можно бы было вынести в .env для легкой модификации, но тогда вообще уже лучше раскатывать удаленный
// сервис для хранения секретов по типу vault для автономности таких изменений и мгновенного вступления в силу.
